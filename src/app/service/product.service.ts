...
export class ProductService {
  list: Product[] = [
    ...
    { id: 2, catId: 3, name: 'SHISEIDO UV PROTECTIVE FOUNDATION', description: 'et commodo vulputate justo in blandit', image: '/assets/img/2.jpg', price: 19896, stock: 349, featured: true, active: false },
	  ...
	  { id: 6, catId: 5, name: 'Atenolol', description: 'tortor id nulla ultrices aliquet maecenas', image: '/assets/img/6.jpg', price: 6304, stock: 190, featured: false, active: true },
	  { id: 7, catId: 5, name: 'rexall ibuprofen', description: 'lorem vitae mattis', image: '/assets/img/7.jpg', price: 3656, stock: 284, featured: false, active: false },
	  ...
	  { id: 14, catId: 5, name: 'up and up cold and flu relief', description: 'ut ultrices vel augue', image: '/assets/img/14.jpg', price: 34824, stock: 270, featured: true, active: false },
	  { id: 15, catId: 6, name: 'Glytone acne 3P', description: 'urna ut tellus nulla ut erat', image: '/assets/img/15.jpg', price: 14229, stock: 405, featured: false, active: false },
	  { id: 16, catId: 4, name: 'Gemfibrozil', description: 'leo maecenas pulvinar lobortis est phasellus sit amet', image: '/assets/img/16.jpg', price: 14260, stock: 83, featured: false, active: false },
	  ...
	  { id: 19, catId: 6, name: 'good neighbor pharmacy pain relief', description: 'ultrices mattis odio donec vitae nisi', image: '/assets/img/19.jpg', price: 20516, stock: 437, featured: true, active: false },
	  ...
	  { id: 21, catId: 6, name: 'LOBSTER', description: 'dolor morbi vel lectus in quam fringilla rhoncus', image: '/assets/img/21.jpg', price: 33691, stock: 163, featured: true, active: true },
	  { id: 22, catId: 1, name: 'Night Time Cherry', description: 'aliquam augue quam sollicitudin vitae consectetuer eget', image: '/assets/img/22.jpg', price: 27500, stock: 246, featured: false, active: false },
	  ...
	  { id: 24, catId: 3, name: 'Broncofin', description: 'vivamus vestibulum sagittis sapien cum sociis natoque penatibus', image: '/assets/img/24.jpg', price: 15681, stock: 201, featured: false, active: true },
	  ...
	  { id: 26, catId: 4, name: 'CHAPSTICK LIPSHIELD 365', description: 'hac habitasse platea dictumst morbi vestibulum velit', image: '/assets/img/26.jpg', price: 5505, stock: 307, featured: false, active: true },
	  { id: 27, catId: 3, name: 'FRAICHEUR CHEVREFEUILLE ANTIPERSPIRANT AND DEODORANT ROLL-ON', description: 'aenean lectus pellentesque eget nunc donec', image: '/assets/img/27.jpg', price: 27453, stock: 437, featured: false, active: true },
	  ...
	  { id: 30, catId: 5, name: 'CVS Homeopathic SKIN TAG REMOVER', description: 'vel est donec odio justo sollicitudin ut suscipit', image: '/assets/img/30.jpg', price: 38976, stock: 270, featured: false, active: true },
	  { id: 31, catId: 6, name: 'Diethylpropion HCl Immediate-Release', description: 'orci nullam molestie nibh', image: '/assets/img/31.jpg', price: 27730, stock: 458, featured: true, active: false },
	  ...
	  { id: 35, catId: 4, name: 'Drummond American Trade Wind Antimicrobial', description: 'cras non velit nec nisi vulputate nonummy', image: '/assets/img/35.jpg', price: 29341, stock: 199, featured: false, active: false },
	  ...
	  { id: 38, catId: 1, name: 'Standardized Grass Pollen, Redtop', description: 'nulla pede ullamcorper augue a suscipit nulla elit', image: '/assets/img/38.jpg', price: 5976, stock: 406, featured: true, active: true },
	  ...
	  { id: 40, catId: 6, name: 'FENOFIBRATE', description: 'pellentesque ultrices mattis odio donec vitae', image: '/assets/img/40.jpg', price: 19393, stock: 279, featured: true, active: true },
	  { id: 41, catId: 2, name: 'ULMUS CRASSIFOLIA POLLEN', description: 'ultrices mattis odio donec', image: '/assets/img/41.jpg', price: 24109, stock: 440, featured: false, active: false },
	  { id: 42, catId: 5, name: 'Midol Complete', description: 'semper rutrum nulla nunc purus', image: '/assets/img/42.jpg', price: 5501, stock: 264, featured: false, active: false },
	  ...
	  { id: 44, catId: 6, name: 'SENSAI CELLULAR PERFORMANCE INTENSIVE HAND TREATMENT', description: 'enim lorem ipsum', image: '/assets/img/44.jpg', price: 13902, stock: 17, featured: false, active: true },
	  ...
	  { id: 49, catId: 5, name: 'Good Neighbor Pharmacy Childrens Ibuprofen Cold', description: 'dolor vel est donec odio justo', image: '/assets/img/49.jpg', price: 16998, stock: 389, featured: false, active: false },
