...
export class ProductService {
  list: Product[] = [
    ...
    { id: 2, catId: 3, name: 'SHISEIDO UV PROTECTIVE FOUNDATION', description: 'et commodo vulputate justo in blandit', image: '/assets/img/2.jpg', price: 19896, stock: 349, featured: true, active: false },
	  ...
	  { id: 14, catId: 2, name: 'up and up cold and flu relief', description: 'ut ultrices vel augue', image: '/assets/img/14.jpg', price: 34824, stock: 270, featured: true, active: false },
	  ...
	  { id: 19, catId: 2, name: 'good neighbor pharmacy pain relief', description: 'ultrices mattis odio donec vitae nisi', image: '/assets/img/19.jpg', price: 20516, stock: 437, featured: true, active: false },
	  ...
	  { id: 35, catId: 1, name: 'Drummond American Trade Wind Antimicrobial', description: 'cras non velit nec nisi vulputate nonummy', image: '/assets/img/35.jpg', price: 29341, stock: 199, featured: true, active: false },
	  ...
	  { id: 44, catId: 2, name: 'SENSAI CELLULAR PERFORMANCE INTENSIVE HAND TREATMENT', description: 'enim lorem ipsum', image: '/assets/img/44.jpg', price: 13902, stock: 17, featured: true, active: true },
